document.getElementById('submit').addEventListener('click', function(event) {
    ...
    const formData = {
        ...
        income: parseInt(document.getElementById('loanAmount').value),
        ...
        dtiRatio: parseFloat(parseInt(document.getElementById('loanAmount').value)/parseInt(document.getElementById('loanAmount').value)),
